...
1. **Run the Awwwards review checklist** (mandatory — see `templates/review-checklist.md`): 7 categories, 1-10 each (max 70). Total < 42 = fail; 42-55 = needs work; ≥ 56 = ship-able. The seventh category is Interaction & a11y, and several of its lines require a measurement (emulated reduced-motion, computed contrast) rather than a judgement.
...
7. If the page passes review with ≥ 56/70: proceed to ship.

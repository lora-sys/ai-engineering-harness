...
真实接管前后对比。每个案例包含：接手前状态、Harness 做了什么、接手后状态、可量化的结果。
...
1. **推文 / V2EX** → 引用案例 1 的 Chaos Score 对比（35 → 87）
2. **知乎 / 博客** → 用案例 2 的自审做"诚实"叙事
3. **演示** → 现场跑 Quick Scan，展示案例 3 的 30 秒接管
4. **README** → 每个案例一个 badge + 一句话摘要
